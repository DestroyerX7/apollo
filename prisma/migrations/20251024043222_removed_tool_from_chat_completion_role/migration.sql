/*
  ...
  - The values [tool] on the enum `ChatCompletionRole` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ChatCompletionRole_new" AS ENUM ('system', 'user', 'assistant');
